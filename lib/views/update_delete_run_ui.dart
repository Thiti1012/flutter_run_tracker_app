...
class UpdateDeleteRunUi extends StatefulWidget {
  //สร้างตัวแปรรับข้อมูลที่ส่งมาจากหน้า showAllRunUi เพื่อเอาไปแสดงในช่องกรอกข้อมูล
  Run? run;
  //เอาตัวแปรที่รับค่ามามาส่งมา
...
class _UpdateDeleteRunUiState extends State<UpdateDeleteRunUi> {
  ...
  void initState() {
    ...
    runWhoCtrl.text = widget.run!.runWho;
